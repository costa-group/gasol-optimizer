...
'''
def evm2rbr_compiler(contract_name = None,block = None, block_id = -1,preffix = "",simplification = True, storage = False):
    global rbr_blocks
    ...
    try:
        ...
        smt_translate_block(rule,contract_name,preffix,simplification,storage)
