...
'''
def evm2rbr_compiler(file_name = None, contract_name = None,block = None, block_id = -1,preffix = "",simplification = True, storage = False, size = False, part = False, pop = False):
    global rbr_blocks
    ...
    try:
        ...
        subblocks = smt_translate_block(rule,file_name,contract_name,preffix,simplification,storage, size, part, pop)
